...
You can then execute your native executable with: `./target/camel-catalog-mcp-1.0.0-SNAPSHOT-runner`

If you want to learn more about building native executables, please consult <https://quarkus.io/guides/maven-tooling>.

## Deploying to IBM Cloud OpenShift

To deploy the application to IBM Cloud OpenShift:

1. Login to the camel-dev OpenShift instance hosted on IBM Cloud:
```shell script
oc login
```

2. Change to the camel-catalog-mcp project:
```shell script
oc project camel-catalog-mcp
```

3. Build and deploy the application with an exposed route:
```shell script
mvn install -Dquarkus.openshift.deploy=true -Dquarkus.openshift.route.expose=true
```
